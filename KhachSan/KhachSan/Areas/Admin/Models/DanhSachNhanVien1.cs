...
{
    public class DanhSachNhanVien1 
    {
        ...
        public DanhSachNhanVien1() { }
        public DanhSachNhanVien1(string taikhoan, string hoten, string matkhau, string gioitinh, DateTime? ngaysinh, string sdt, string email, string tendiachi,string chitietdiachi, int? trangthai)
        {
